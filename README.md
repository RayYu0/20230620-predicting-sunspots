...
This research paper examines the accuracy of predicting the number of sunspots on a given day. 
...
the model to be most accurate when around 20-40 days of data are given. 
